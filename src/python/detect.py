...
from utils import load_image, load_images, load_class_names, draw_boxes, draw_frame
...
def main(type, iou_threshold, confidence_threshold, img):
    ...
    if type == 'images':
        ...
        batch = load_image(img, model_size=_MODEL_SIZE)
        ...
        people_present = draw_boxes(img, detection_result, class_names, _MODEL_SIZE)

        print('Detections have been saved successfully.')
        print('People present:', people_present)
